...
func InitApp(cfg *app.Config) (*app.App, func(), error) {
	...
	companyCache := cache.NewCompanyCache(client)
	companyRepo := repository.NewCompanyRepo(dbClient, companyCache)
	companyServiceServer := service.NewCompanyServiceServer(companyRepo)
