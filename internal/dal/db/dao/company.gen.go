...
func newCompany(db *gorm.DB, opts ...gen.DOOption) company {
	...
	_company.WalletAddress = field.NewString(tableName, "wallet_address")
	_company.ID = field.NewInt64(tableName, "id")
	_company.LogoURL = field.NewString(tableName, "logo_url")
...
func (c *company) updateTableName(table string) *company {
	...
	c.WalletAddress = field.NewString(table, "wallet_address")
...
func (c *company) fillFieldMap() {
	...
	c.fieldMap["wallet_address"] = c.WalletAddress
	c.fieldMap["id"] = c.ID
...
type ICompanyDo interface {
	...
	GetUserByUsername(username string) (result *model.Company, err error)
	GetUserByPhone(phone string) (result *model.Company, err error)
	GetUserByEmail(email string) (result *model.Company, err error)
}

// SELECT * FROM @@table WHERE username = @username
func (c companyDo) GetUserByUsername(username string) (result *model.Company, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, username)
	generateSQL.WriteString("SELECT * FROM company WHERE username = ? ")
...
func (c companyDo) GetUserByPhone(phone string) (result *model.Company, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, phone)
	generateSQL.WriteString("SELECT * FROM company WHERE phone = ? ")
...
func (c companyDo) GetUserByEmail(email string) (result *model.Company, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, email)
	generateSQL.WriteString("SELECT * FROM company WHERE email = ? ")
